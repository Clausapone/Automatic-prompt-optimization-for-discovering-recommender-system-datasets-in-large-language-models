...
from .gepa_utils import DspyAdapter, DSPyTrace, PredictorFeedbackFn, ScoreWithFeedback
...
class GEPA(Teleprompter):
    ...
    def compile(
        ...
        *,
        ...
        from .gepa_utils import DspyAdapter, LoggerAdapter
        ...
        # bisogna capire come vengono trattati questi feedback per direzionare il modello
        feedback_map = {
        ...
        gepa_result: GEPAResult = optimize(
            ...
            # prende il primo output del modello
