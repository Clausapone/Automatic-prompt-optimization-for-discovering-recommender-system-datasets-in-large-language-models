...
class DspyAdapter(GEPAAdapter[Example, TraceData, Prediction]):
    ...
    def evaluate(self, batch, candidate, capture_traces=True):
        ...
        for pred_name, instruction in candidate.items():
            ...
            print(f"Instruction: {instruction[:200]}...") # Stampa i primi 200 caratteri
        print(f"{'='*60}\n")
    ...
    def make_reflective_dataset(self, candidate, eval_batch, components_to_update) -> dict[str, list[ReflectiveExample]]:
        # --- CHECKPOINT: INIZIO RIFLESSIONE ---
        print(f"\n{'!'*40}")
        print(f"! CHECKPOINT: ANALYZING ERRORS FOR REFLECTION")
        print(f"{'!'*40}\n")
        # --------------------------------------
